...
using X96J2O_HFT_2021222.Repository.Classes;
using X96J2O_HFT_2021222.Repository.Interfaces;

namespace X96J2O_HFT_2021222.Endpoint
{
    public class Startup
    {
        ...
        {
            services.AddTransient<RentDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "X96J2O_HFT_2021222.Endpoint v1"));
            }
            ...
            .AllowAnyMethod()
            .AllowAnyHeader()
            .WithOrigins("http://localhost:49152"));
            app.UseRouting();
